#!/usr/bin/python3
# Refence: https://www.javaer101.com/ko/article/45758733.html D-503
...
class Main(ttk.Frame):
    ...
    def init_ui(self):
        ...
        self.a = self.fig.subplots(1)
        ax = self.a
        ax.set_ylim((0, 10))
        self.canvas = FigureCanvasTkAgg(self.fig, f)

        # Key FigureCanvasTkAgg implemented animation
        ...
        self.get_radio_buttons(w, 'Choice', self.ops, self.which, self.on_choice_plot).pack(side=tk.TOP, fill=tk.Y,
                                                                                            expand=0)
