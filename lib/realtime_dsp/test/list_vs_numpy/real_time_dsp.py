...
def wave_file_process(in_file_name="",
        ...
        #Checking if 75% overlap to set the FFT input buffer
            ...
            if mode_numpy:
                if stereo:
                    ...
                    input_frames_left_np[block_size:2 * block_size] = input_frames_left_np[2 * block_size:3 * block_size]
                    input_frames_left_np[2 * block_size:3 * block_size] = input_frames_left_np[3 * block_size:4 * block_size]
                    ...
                    input_frames_right_np[block_size:2 * block_size] = input_frames_right_np[2 * block_size:3 * block_size]
                    input_frames_right_np[2 * block_size:3 * block_size] = input_frames_right_np[3 * block_size:4 * block_size]
        ...
        #For 75% applying second window with gain adjustment to normalize output (-1< out <1)
            ...
            if mode_numpy:
                if stereo:
                    ...
                    out_frame_left_np = ifft_out_left_np[:new_frame_size] + windowed_frame_left_np[:new_frame_size]
                    windowed_frame_left_np[:new_frame_size] = windowed_frame_left_np[:new_frame_size] + ifft_out_left_np[:new_frame_size]
                    windowed_frame_left_np[new_frame_size:2 * new_frame_size] = windowed_frame_left_np[new_frame_size:2 * new_frame_size] + ifft_out_left_np[new_frame_size:2 * new_frame_size]
                    ...
                    windowed_frame_right_np[:new_frame_size] = windowed_frame_right_np[:new_frame_size] + ifft_out_right_np[:new_frame_size]
                    windowed_frame_right_np[new_frame_size:2 * new_frame_size] = windowed_frame_right_np[new_frame_size:2 * new_frame_size] + ifft_out_right_np[new_frame_size:2 * new_frame_size]
    ...
    print(f"Total time: {sum(period_list)}, Max Period: {max(period_list)}, Average Period: {sum(period_list)/len(period_list)}")
